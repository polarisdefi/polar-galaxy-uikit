...
var style = (_a$2 = {},
    ...
    _a$2);
var Heading = styled(Text).attrs({ bold: false })(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  ", "\n  // font-weight:600;\n  line-height: 1.1;\n"], ["\n  ", "\n  // font-weight:600;\n  line-height: 1.1;\n"])), function (_a) {
    var size = _a.size;
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                ...
                React.createElement(Heading, { color: "#525AA9" }, title)),
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "124", height: "36", href: isDark ? "images/galaxy/logowithtext.png" : "images/galaxy/logowithtext.png" })));
};
...
var MenuLink = function (_a) {
    ...
    return React.createElement(Tag, __assign({ style: { color: "#7D65FF" } }, props, otherProps));
};
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href, style: { marginLeft: "15px", fontSize: "16px" } }, item.label))); })));
        }
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, onClick: function () {
            ...
            onDismiss();
        }, style: { justifyContent: "start", backgroundColor: "#14102F" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase() },
        React.createElement(Icon, { width: "32px" }),
        React.createElement(Text, { bold: true, ml: "16px" }, title)));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            ...
            React.createElement(Icon$H, { color: "#7D65FF", ml: "6px" }))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#0F0B25", backgroundDisabled: "#0F0B25", contrast: "#191326", invertedContrast: "#99A3FF", input: "#191439", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#5B5B5B", textSubtle: "#7D65FF", borderColor: "#E9EAEB", card: "#110D2A", gradients: {
        bubblegum: "linear-gradient(139.73deg, #99A3FF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "rgba(86,65,216,0.4)", background: "#0F0B25", backgroundDisabled: "#0F0B25", contrast: "#FFFFFF", invertedContrast: "#99A3FF", input: "#191439", primaryDark: "#99A3FF", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#5B5B5B", textSubtle: "#7D65FF", borderColor: "#524B63", card: "#110D2A", gradients: {
